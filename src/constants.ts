...
const UPCLOUD_API_KEY = '';
const UPCLOUD_API_SECRET = '';
...
const UPCLOUD_SERVER_TYPE = 'DEV-1xCPU-1GB-10GB';
const EXOSCALE_TEMPLATE_NAME = 'Linux Debian 12 (Bookworm) 64-bit';
const HETZNER_INSTANCE_IMAGE = 'debian-12';
const UPCLOUD_INSTANCE_IMAGE = '01000000-0000-4000-8000-000020070100';
